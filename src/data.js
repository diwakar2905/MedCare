...
export const doctors = [
  { id: 1, name: 'Dr. Rajesh Sharma', speciality: 'Cardiology', experience: 18, hospital: 'MedCare Delhi', fee: 800, gender: 'Male', available: 'Today', bio: 'One of India\'s leading cardiologists with expertise in interventional cardiology, angioplasty, and heart failure management.', education: 'MBBS, MD (Cardiology) – AIIMS Delhi', languages: ['English', 'Hindi'], rating: 4.9 },
  { id: 2, name: 'Dr. Priya Verma', speciality: 'Neurology', experience: 14, hospital: 'MedCare Mumbai', fee: 900, gender: 'Female', available: 'Today', bio: 'Specializes in stroke management, epilepsy treatment, and neuro-degenerative disorders.', education: 'MBBS, DM (Neurology) – CMC Vellore', languages: ['English', 'Hindi', 'Marathi'], rating: 4.8 },
  { id: 3, name: 'Dr. Anil Kumar', speciality: 'Orthopedics', experience: 22, hospital: 'MedCare Bangalore', fee: 700, gender: 'Male', available: 'Tomorrow', bio: 'Expert in joint replacements, sports injuries, and spine surgery with over 5000+ successful surgeries.', education: 'MBBS, MS (Orthopedics) – KMC Manipal', languages: ['English', 'Hindi', 'Kannada'], rating: 4.7 },
  { id: 4, name: 'Dr. Sneha Patel', speciality: 'Gynecology', experience: 12, hospital: 'MedCare Ahmedabad', fee: 600, gender: 'Female', available: 'Today', bio: 'Renowned for high-risk pregnancy management, laparoscopic surgery, and fertility treatments.', education: 'MBBS, MS (OBG) – BJ Medical College', languages: ['English', 'Hindi', 'Gujarati'], rating: 4.9 },
...
export const blogs = [
  { id: 1, title: '10 Warning Signs of Heart Disease You Shouldn\'t Ignore', excerpt: 'Heart disease is the leading cause of death worldwide. Learn to recognize the early warning signs that could save your life.', category: 'Cardiology', date: 'March 18, 2026', icon: '❤️' },
  { id: 2, title: 'Understanding Diabetes: Prevention & Management Guide', excerpt: 'A comprehensive guide to understanding diabetes, its risk factors, prevention strategies, and modern management approaches.', category: 'Endocrinology', date: 'March 15, 2026', icon: '💉' },
  { id: 3, title: 'Benefits of Regular Health Checkups After 40', excerpt: 'Why preventive health screening becomes critical after 40 and which tests you should get done annually.', category: 'Preventive Care', date: 'March 12, 2026', icon: '🩺' },
